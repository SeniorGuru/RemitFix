        ...
        <Box className={classes.root}>
            <Box className={classes.gradient}>
                ...
                <Box className={classes.description}>
                    Complete your agent’s profile
                </Box>
                <Box className={classes.label}>
                    We won’t be able to process your transfer until you complete your profile.
                </Box>
...
export default VerificationNOKTier1 ;