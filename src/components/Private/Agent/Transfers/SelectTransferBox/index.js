        ...
        <Box className={classes.root}>
            ...
            <Box className={classes.select}>
                <Button
                    ...
                    color={'primary'}
                    onClick={() => handleSelectChange("outgoing")}
                >
                    <Link
                        to={'/private/agent/transfers/outgoing'}
                ...
                <Button
                    ...
                    color={'primary'}
                    onClick={() => handleSelectChange("incoming")}
                >
                    <Link
                        to={'/private/agent/transfers/incoming'}
...
export default SelectAgentTransferBox;