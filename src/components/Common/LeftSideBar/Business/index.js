...
const LeftSideBar = () => {
    ...
    const menuList = [
        {
            label : 'Transfers' ,
            link : '/private/business/transfers'
        },
        {
            label : 'Recipients',
            link : '/private/business/recipients'
        },
        {
            label : 'Users',
            link : '/private/business/users'
        },
        {
            label : "Invite and earn 50 NOK",
            link : '/private/business/invite'
        },
        {
            label : "Verification",
            link : '/private/business/verification'
        }
    ] ;
